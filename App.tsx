...
const styles = StyleSheet.create({
  ...
  cardTileImage: { width: '100%', aspectRatio: 0.72, borderRadius: 10, backgroundColor: '#1E293B', filter: 'saturate(1.08) contrast(1.04) brightness(0.96)' as any },
  cardImageToneOverlay: { position: 'absolute', inset: 0, borderRadius: 10, backgroundColor: 'rgba(15, 23, 42, 0.03)' },
  ...
  cardHalfImage: { flex: 1, height: 360, borderRadius: 20, backgroundColor: '#1E293B', filter: 'saturate(1.08) contrast(1.04) brightness(0.95)' as any },
  cardImageToneOverlayLarge: { position: 'absolute', inset: 0, borderRadius: 20, backgroundColor: 'rgba(15, 23, 42, 0.035)' },
