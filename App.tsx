...
const universeLogos: Partial<Record<UniverseId, any>> = {
  ...
  'shaman-king': require('./assets/shaman-king-logo.png'),
  medarot: require('./assets/medarot-logo.png'),
  'angels-friends': require('./assets/angels-friends-logo.png'),
  'power-rangers': require('./assets/power-rangers-logo.png'),
