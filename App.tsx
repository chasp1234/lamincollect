...
const styles = StyleSheet.create({
  ...
  cardTileImageTonedDown: { filter: 'saturate(1.14) contrast(1.02) brightness(0.9)' as any },
  ...
  cardHalfImageTonedDown: { filter: 'saturate(1.15) contrast(1.02) brightness(0.91)' as any },
