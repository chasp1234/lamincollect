...
const styles = StyleSheet.create({
  ...
  homeRoof: { width: 0, height: 0, borderLeftWidth: 8, borderRightWidth: 8, borderBottomWidth: 7, borderLeftColor: 'transparent', borderRightColor: 'transparent', borderBottomColor: '#E2E8F0', marginBottom: -1, marginLeft: 0 },
  homeBody: { width: 12, height: 8, backgroundColor: '#E2E8F0', borderTopLeftRadius: 0, borderTopRightRadius: 0, borderBottomLeftRadius: 2, borderBottomRightRadius: 2, marginTop: 0, marginLeft: 0 },
